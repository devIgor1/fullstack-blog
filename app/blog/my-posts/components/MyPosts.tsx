...
export default function MyPosts({ posts }: MyPostsProps) {
  ...
  return (
    <>
      {posts.length === 0 ? (
        <div className="flex flex-col items-center justify-center px-4 space-y-4 text-center md:px-6 mt-5">
